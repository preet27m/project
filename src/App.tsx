...
import FallingTrashGame from './FallingTrashGame';
...
function App() {
  ...
  return (
    <>
      <FallingTrashGame />
      <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8" style={{ position: 'relative', zIndex: 1, background: 'rgba(255,255,255,0.7)' }}>
